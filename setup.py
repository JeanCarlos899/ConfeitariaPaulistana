...
menu = MenuPrincipal.menu_principal()
nova_encomenda = None
dados_cliente = None
lista_encomenda = None
menu_encomenda = None
dar_baixa_encomenda = None
salgadinhos = None
mais_informacoes = None
graficos = None
relatorios = None
deletar_encomenda = None 
...
def functionsMenu(evento):

    global nova_encomenda
    global dados_cliente 
    global lista_encomenda 
    global menu_encomenda 
    global dar_baixa_encomenda
    global salgadinhos 
    global mais_informacoes 
    global graficos 
    global relatorios 
    global deletar_encomenda 
    global editar_encomenda 
    global faturamento 
    global lucro_do_mes 
    global local 
    global recuperar
...
while True:
    ...
    if janela == menu:
        sair = functionsMenu(evento)

        if sair == False:
            break

    elif janela == nova_encomenda:
        newOrder(evento, valor)

    elif janela == menu_encomenda:
        listOrder(evento, valor)
        ...
        delOrder(evento, valor)

    elif janela == editar_encomenda:
        editOrder(evento, valor)

    elif janela == faturamento:
        revenues(evento, valor)

    elif janela == lucro_do_mes:
        monthlyPofit(evento, valor)
